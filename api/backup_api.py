...
This version **requires a Bearer token** for all endpoints. Valid tokens are read
from the environment variable `APP_TOKENS` as a comma-separated list:
...
If APP_TOKENS is not set or empty the app will return 500 (misconfigured).
"""
